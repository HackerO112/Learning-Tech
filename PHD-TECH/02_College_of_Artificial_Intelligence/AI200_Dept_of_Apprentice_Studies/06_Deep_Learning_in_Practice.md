# AI201, Day 6: Deep Learning in Practice
...
Let's solve the same problem as Day 4 (classifying Iris flowers), but this time with a deep neural network. This will allow us to directly compare the workflow.
...
1.  Create a new file named `day11_ai.py`.
